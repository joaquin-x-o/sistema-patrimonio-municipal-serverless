...
import { EnableUserForm } from "../../../components/features/users/forms/EnableUserForm";
...
export default function EnableUser() {
    ...
    return (
        <FormLayout title="Gestión de Usuarios">
            ...
            {currentStep === "SEARCH_CODE" && (
                <StepLayout variant="search">
                    ...
                    <SearchCodeForm
                        ...
                        label="Escriba el nombre de usuario que desee habilitar:"
            ...
            {/* PASO 2: formulario para confirmar el usuario por habilitar */}
            {
